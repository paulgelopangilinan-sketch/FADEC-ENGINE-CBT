/* =====================================================
   ...
   FEATURES:
   - 8 second engine start
   - 8 second engine stop
   - Start / stop audio
   - Looping caution audio
   - Looping warning audio
   - Full screen caution flicker
   - Full screen warning flicker
...
const flashStatus =
    document.getElementById("flashStatus");
...
/* =====================================================
   PREPARE LOOPING ALERT SOUNDS
   ===================================================== */

cautionSound.loop = true;
...
function toggleSound() {
    ...
    if (!soundEnabled) {
        ...
        stopSound(startEngineSound);

        stopSound(stopEngineSound);
        ...
        /*
           If an alert is currently active,
           immediately resume its sound.
        */

        if (currentAlertState === "caution") {

            playSound(cautionSound);

        }

        else if (currentAlertState === "warning") {
...
function changeAlertState(newState) {

    /*
       If the state has not changed,
       do not restart the sound.
    */
    ...
    */
    ...
    /*
       Remove previous screen effects.
    */
...
function startEngine() {
    ...
    /*
       Make sure alert sounds are stopped
       while starting.
    */
    ...
    engineProgress.classList.remove(
        "hidden"
    );
...
function finishEngineStop() {
    ...
    /*
       Make absolutely sure alerts are off.
    */
...
function startAssessment() {
    ...
    assessmentResult.innerHTML = `
        ...
        1. Start the engine using START ENGINE.
        <br>

        2. Adjust the AIR VOLUME INPUT.
        <br>
...
function showHelp() {
    ...
    alert(
        ...
        "2. Wait for the 8-second start sequence.\n" +
        ...
        "7. Caution and warning sounds loop while active.\n" +

        "8. Use FLASH to enable or disable screen flashing.\n" +

        "9. Run diagnostics.\n" +

        "10. Use STOP ENGINE for the 8-second shutdown sequence."
